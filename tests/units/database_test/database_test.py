...
class DatabaseTest(TestCase):
    ...
    def setUpClass(cls):
        ...
        Database.insert_one(_get_test_data(), DB_NAME)

    @classmethod
    def tearDownClass(cls):
        """Tears down the database"""
        Database.remove_db(DB_NAME)
    ...
    def test_can_a_single_user_details_be_saved_to_the_database__Should_save_the_user_details_to_database(self):
        ...
        self.assertIsNotNone(Database.find_one({'first_name':'Egbie'}, db_name=DB_NAME))
    ...
    def test_can_two_user_details_be_saved_to_the_database__Should_save_two_the_user_details_to_database(self):
        ...
        Database.insert_one(user_data, DB_NAME)

        query_data1 = Database.find_one({'first_name':'Egbie'}, db_name=DB_NAME)
        query_data2 = Database.find_one({'first_name':'Egbie1'}, db_name=DB_NAME)
    ...
    def test_can_the_user_data_be_retreived_from_the_database_using_a_correct_username__Should_retreive_all_user_data(self):
        ...
        self.assertIsNotNone(Database.find_one({'username': 'abby'}, db_name=DB_NAME))
    ...
    def test_can_the_user_data_be_retreived_from_the_database_when_an_invalid_username_is_entered__Should_return_none(self):
        ...
        self.assertIsNone(Database.find_one({'username': 'name_does_not_exist_in_db'}, db_name=DB_NAME))
    ...
    def test_can_the_user_data_be_retrieived_from_the_database_with_a_correct_email_address__Should_return_all_user_data(self):
        ...
        self.assertIsNotNone(Database.find_one({'email': 'egbie@example.com'}, db_name=DB_NAME))
    ...
    def test_can_the_user_data_be_retreived_from_the_database_when_an_invalid_email_is_entered__Should_return_none(self):
        ...
        self.assertIsNone(Database.find_one({'email': 'email_does_not_exist@example.com'}, db_name=DB_NAME))
    ...
    def test_can_the_user_data_be_retrieived_from_the_database_using_the_author_name__Should_return_all_user_data(self):
        ...
        self.assertIsNotNone(Database.find_one({'author_name': 'egbies'}, db_name=DB_NAME))
    ...
    def test_can_the_user_data_be_retrieived_from_the_database_using_an_incorrect_author_name__Should_return_none(self):
        ...
        self.assertIsNone(Database.find_one({'author_name': 'fake_name'}, db_name=DB_NAME))
    ...
    def test_can_the_user_update_the_data_in_the_database__Should_update_the_user_details(self):
        ...
        data = Database.find_one({'first_name': 'Egbie'}, DB_NAME)
        _update_data(data, field_to_update='last_name', new_data='Ullu', _id=data.get('_id'))
        Database.update('_id', data.get('_id'), data, db_name=DB_NAME)

        self.assertIsNotNone(Database.find_one({'last_name': 'Ullu'}, DB_NAME))
